...
class XooPublisher
{
	...
	function get_all_post_types()		
	{
		...
		$html .= '<label>
		<input type="checkbox" name="uultra_all_post_types[]" value="page" id="uultra_all_post_types" '.$selected_page.' />page</label>
		<br />';
		$html .= '<label>
		<input type="checkbox" name="uultra_all_post_types[]" value="post" id="uultra_all_post_types" '.$selected_post.' />post</label>
		<br />';
